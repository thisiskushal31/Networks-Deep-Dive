...
**Takeaway:** Treat the device’s **REST API** like a **management interface**: restrict who can reach it, require strong auth and TLS, limit rate, and log access. See [observability/6-network-operations](../observability/6-network-operations.md) for model-driven programmability (NETCONF, RESTCONF, YANG).
...
- [1-overview-perimeter](./1-overview-perimeter.md) (firewall basics); [cloud-native/1-cloud-networking-overview](../cloud-native/1-cloud-networking-overview.md) (VPC, subnets)
- [NIDS & DoS](./7-nids-dos-identity.md); [Attacks & mitigations](./4-attacks-mitigations.md)
