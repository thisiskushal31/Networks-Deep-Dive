...
See [security/4-attacks-mitigations](../security/4-attacks-mitigations.md) for DHCP attacks in the security section.
...
- [Application overview – protocols](./1-application-overview.md); [Security – DHCP attacks](../security/4-attacks-mitigations.md)
