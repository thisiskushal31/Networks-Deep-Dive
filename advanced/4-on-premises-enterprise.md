...
- **Layer-by-layer:** **Physical** (link up? cable? wrong port?), **L2** (VLAN, STP, MAC), **L3** (IP, routing, ACL), **L4** (firewall, NAT, port). See [observability/6-network-operations](../observability/6-network-operations.md) (troubleshooting methodology).
...
- [routing-switching/5-switching-resiliency-design](../routing-switching/5-switching-resiliency-design.md); [observability/6-network-operations](../observability/6-network-operations.md); [labs/3-operational-simulators-tools](../labs/3-operational-simulators-tools.md)
