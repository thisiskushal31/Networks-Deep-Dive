...
**Transition:** Dual stacking (run both), tunneling (IPv6 over IPv4), and NAT64/translators allow coexistence. IPv6 uses **Neighbor Discovery (ND)** instead of ARP for address resolution on the link. See [security/6-ipsec-vpns](../security/6-ipsec-vpns.md) for IPv6 over IPv4 tunneling.
