...
### [1. Basics & architecture](./1-basics-and-architecture.md)
...
### [4. Data link layer](./4-data-link-layer.md)
...
### [5. Network layer](./5-network-layer.md)
...
1. [Basics & architecture](./1-basics-and-architecture.md) → [Models](./2-models.md) → [Physical layer](./3-physical-layer.md) → [Data link layer](./4-data-link-layer.md) → [Network layer](./5-network-layer.md)
