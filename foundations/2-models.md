...
- **Functions:**
  ...
  - **Transmission mode** — Defines how data flows between the two connected devices: simplex, half-duplex, or full-duplex (see [Physical layer](./3-physical-layer.md)).
...
- **Protocols:** Ethernet, PPP. See [Data link layer](./4-data-link-layer.md).
...
- **Protocols:** IP, ICMP, IGMP, OSPF, etc. See [Network layer](./5-network-layer.md).
...
See [Transport layer](../transport/README.md) (TCP, UDP), [Services](../services/README.md) (HTTP, DNS, DHCP, etc.), and [security/2-encryption-tls](../security/2-encryption-tls.md) (TLS/HTTPS).
